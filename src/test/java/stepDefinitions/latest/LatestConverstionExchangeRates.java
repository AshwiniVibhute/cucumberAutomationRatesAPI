package stepDefinitions.latest;
...
public class LatestConverstionExchangeRates {
	...
	@When("I hit API using HTTP get method with {string} as endpoint")
	...
	@Then("JSON response body contains the yesterday's date in {string} format")
	public void json_response_body_contains_the_yesterday_s_date_in_format(String string) {
		JsonPath jsonObj = response.jsonPath();
		...
		Assert.assertEquals(dateString, dateObj.toString());
	}
	...
	@When("I hit API using HTTP get method with {string} as endpoint and query params as symbols equal to {string}")
	...
	@When("I hit API using HTTP get method with {string} as endpoint and query params base as {string}")
	...
	@When("I hit API using HTTP get method with {string} as endpoint and query params as symbols equal to {string} and base as {string}")
